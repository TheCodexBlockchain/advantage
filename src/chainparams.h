...
#define __PORT_MAINNET__ 8338
#define __PORT_TESTNET__ 18338
#define __PORT_REGTEST__ 28338
 ...
 * itcoin system. There are three: the main network on which people trade goods
