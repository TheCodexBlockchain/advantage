...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected itcoin supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check itcoin supply at the beginning
        # ------------------------------------------
        # itcoin supply: block rewards minus burned fees for minting
        ...
        # Verify that itcoin supplies were properly updated after the spends and reorgs
        self.log.info("Check itcoin supply...")
