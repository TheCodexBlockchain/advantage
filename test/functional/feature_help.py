...
"""Verify that starting itcoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start itcoin with -? for help text")
        ...
        self.log.info("Start itcoin with -version for version information")
