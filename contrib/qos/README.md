...
This means one can have an always-on itcoind instance running, and another local itcoind/itcoin-qt instance which connects to this node and receives blocks from it.
