...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='itcoin.conf'
CONFIGFOLDER='/root/.itcoin'
COIN_DAEMON='itcoind'
COIN_CLI='itcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/TheCodexBlockchain/itcoin/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
